...
start "ACCEPTOR5" cmd /k "python env.py config0 5 ACCEPTOR"
start "ACCEPTOR6" cmd /k "python env.py config0 6 ACCEPTOR"
...
start "LEADER3" cmd /k "python env.py config0 3 LEADER"
...
start "REPLICA3" cmd /k "python env.py config0 3 REPLICA"
